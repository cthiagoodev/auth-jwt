...
import br.com.thiagoodev.authjwt.application.response.JwtResponse
...
class AuthenticationController(
    ...
    fun register(@Valid @RequestBody form: RegisterUserDTO): ResponseEntity<User> {
        try {
    ...
    @PostMapping("/login")
    fun login(@Valid @RequestBody form: LoginUserDTO): ResponseEntity<JwtResponse> {
        try {
            ...
            val response = JwtResponse(token, expiration)
